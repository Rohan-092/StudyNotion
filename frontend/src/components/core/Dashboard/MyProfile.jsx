    ...
    return(
        <div className="text-richblack-5">
            ...
            <div className="my-10 flex flex-col gap-y-10 rounded-md border-[1px] border-richblack-700 bg-richblack-800 p-8 px-12">
                ...
                <p className="text-richblack-400 text-sm font-medium">{user?.additionalDetails?.about ?? "write about yourself"}</p>
            </div>
                ...
                <div className="flex max-w-[500px] justify-between">
                    ...
                    <div className="flex flex-col gap-y-5">
                        ...
                        <div>
                            ...
                            <p className="text-sm font-medium text-richblack-5">
                                {user?.additionalDetails?.contactNumber ?? "add contactNumber"}
                            </p>
                        </div>
                        <div>
                            <p className="mb-2 text-sm text-richblack-600">
                            ...
                            <p className="text-sm font-medium text-richblack-5">
                                {user?.additionalDetails?.dateOfBirth ?? "add dateOfBirth"}
                            </p>
                        </div>
                    </div>
                </div>    
