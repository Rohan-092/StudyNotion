...
import Stats from "../components/core/AboutPage/StatsComponent.jsx"
  ...
  return (
    <div className="text-white">
        ...
        <section className="bg-richblack-700">
            <div className="relative w-11/12 max-w-maxContent mx-auto flex flex-col justify-between gap-10 text-center text-white">
                <header className="mx-auto my-16 text-4xl font-semibold lg:w-[70%]">
                    Driving Innovation in Online Education for a 
                    <HighlightText text={" Brighter Future"} />
                    <p className="mt-3 text-center text-base font-medium text-richblack-300">
                ...
                <div className="absolute bottom-[-100px]  grid w-[100%] grid-cols-3 gap-3 lg:gap-5">
        ...
        <section className="mt-6">
            <div className="h-[340px] w-11/12 max-w-maxContent mx-auto flex justify-center items-center"> 
                <Quote />
            </div>
        </section>
        ...
        <section>
            <div className="w-11/12 max-w-maxContent mx-auto flex flex-col justify-between gap-10">
                <div className="flex flex-col items-center gap-10 lg:flex-row justify-between mt-10">
                ...
                <div className="flex flex-col items-center lg:gap-10 lg:flex-row justify-between my-24">
